...
let oNum = oDoc.CreateNumbering();
console.log(oNum.GetClassType())
...
oPar5.AddNumberedCrossRef('text', oNumParLvl1, true, false, ' ');
oPar6.AddNumberedCrossRef('aboveBelow', oNumParLvl1, true, false, ' ');
